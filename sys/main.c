...
void test3 ()
{
	...
	//kprintf("get prio A is %d\n",getprio(rd1));
/*	kprintf("-changing priority test.reader B(prio 30) changed to 15\n");
	chprio(rd2,15);
	sleep(1);
	assert(getprio(wr1) == 25,"Test 3 failed"); 
*/	
...
void test4 ()
{
	...
	rd1 = create(reader4, 2000, 20, "reader2", 3, 'A', lck, 20);
	rd2 = create(reader4, 2000, 20, "reader2", 3, 'B', lck, 30);
	rd3 = create(reader4, 2000, 20, "reader2", 3, 'D', lck, 25);
	rd4 = create(reader4, 2000, 20, "reader2", 3, 'E', lck, 20);
        wr1 = create(writer4, 2000, 20, "writer2", 3, 'C', lck, 25);
	
        //kprintf("-start writer E, then sleep 1s. lock granted to writer E\n");
        resume(rd3);
        sleep (1);

       // kprintf("-start reader A, then sleep 1s. reader waits for the lock\n");
        resume(wr1);
        sleep (1);


      //  kprintf("-start reader B, D, E. reader B wait.\n");
        resume (rd1);
	resume (rd2);
	resume (rd4);
        ...
        kprintf("output=%s\n", output4);
    // ABD(ABD in arbitrary orders)CCEE
             assert(mystrncmp(output4,"CCEBEBDA",10)==0,"Test 4 FAILED\n");
                     kprintf ("Test 4 OK\n");
                     }
...
void test5 ()
{
	...
	rd2 = create(reader5, 2000, 20, "reader5", 3, 'B', lck, 30);
	rd3 = create(reader5, 2000, 20, "reader5", 3, 'D', lck, 25);
	rd4 = create(reader5, 2000, 20, "reader5", 3, 'E', lck, 20);
        wr1 = create(writer5, 2000, 20, "writer5", 3, 'C', lck, 25);
		wr2 = create(writer5, 2000, 20, "writer5", 3, 'F', lck, 20);
